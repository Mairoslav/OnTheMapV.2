...
class ClientUdacityApi {
    ...
    enum Endpoints {
        ...
        var stringValue: String {
            switch self {
                ...
                case .sessionId:
                    return Endpoints.base + Endpoints.sessionPath // sessionId: used for loggingIn / logout
                case .publicUserData:
    ...
    // MARK: GET
    // 11. Udacity API: GETting Public User Data - The whole purpose of using Udacity's API is to retrieve some basic user information before posting data to Parse. This is accomplished by using Udacity’s user method: "https://onthemap-api.udacity.com/v1/users/<user_id>", see ".publicUserData" case.
    ...
    @discardableResult class func taskForPOSTRequest<RequestType: Encodable, ResponseType: Decodable>(url: URL, getSessionId: Bool, responseType: ResponseType.Type, body: RequestType, completion: @escaping (ResponseType?, Error?) -> Void) -> URLSessionTask {
    ...
    class func login(username: String, password: String, completion: @escaping (Bool, Error?) -> Void) {
        ...
        taskForPOSTRequest(url: Endpoints.sessionId.url, getSessionId: true, responseType: SessionResponse.self, body: body) { response, error in
    ...
    class func logout(completion: @escaping (Bool, Error?) -> Void) {
        taskForDELETERequest(url: Endpoints.sessionId.url, responseType: LogoutResponse.self) { response, error in
            if response != nil {
                Auth.userId = ""
                Auth.objectId = ""
                Auth.firstName = ""
