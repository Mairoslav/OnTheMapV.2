...
// 4. Parse API: What is a Student Location?
// B.2. "GetStudentInformation" struct to store individual locations and links downloaded from the service

// B.3. the "GetStudentInformation" struct initialize instances from a dictionary. The struct has an init() method that accepts a dictionary as an argument, or the struct conforms to the Codable protocol (2nd is valid).
